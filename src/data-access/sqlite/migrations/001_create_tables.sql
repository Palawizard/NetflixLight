...
CREATE INDEX IF NOT EXISTS idx_watchlist_items_profile ON watchlist_items(user_id, profile_id, added_at DESC);
CREATE INDEX IF NOT EXISTS idx_watch_progress_profile ON watch_progress(user_id, profile_id, updated_at DESC);
CREATE INDEX IF NOT EXISTS idx_viewing_history_user ON viewing_history(user_id, viewed_at DESC);
CREATE INDEX IF NOT EXISTS idx_viewing_history_profile ON viewing_history(user_id, profile_id, viewed_at DESC);
CREATE INDEX IF NOT EXISTS idx_user_ratings_user ON user_ratings(user_id, updated_at DESC);
CREATE INDEX IF NOT EXISTS idx_user_ratings_profile ON user_ratings(user_id, profile_id, updated_at DESC);
