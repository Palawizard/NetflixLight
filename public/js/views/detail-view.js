    ...
    <section class="space-y-4 rounded-4xl border border-white/10 bg-white/5 p-8 shadow-xl shadow-black/20 backdrop-blur">
      ...
      >
        ...
        <div
          ...
          hidden
          class="space-y-3 border-t border-white/10 bg-black/90 px-5 py-4"
          aria-label="Contrôles du lecteur vidéo"
        >
          <div class="flex items-center gap-3">
            <span
              data-player-time
              class="w-[9ch] shrink-0 text-right text-xs tabular-nums text-white/50"
              aria-live="off"
            >0:00 / 0:00</span>
            <div
              ...
              aria-valuemax="100"
              tabindex="0"
              class="relative h-2 flex-1 cursor-pointer rounded-full bg-white/20 transition-colors hover:bg-white/30 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-rose-300"
            >
              <div
          ...
          <div class="flex items-center gap-2">
            <button
              ...
              aria-label="Lire"
              aria-pressed="false"
              class="inline-flex h-9 w-9 items-center justify-center rounded-full bg-white/10 text-white transition hover:bg-white/20 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-rose-300"
            >
            ...
            <button
              ...
              class="inline-flex h-9 w-9 items-center justify-center rounded-full bg-white/10 text-white transition hover:bg-white/20 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-rose-300"
            >
              <svg data-icon-unmuted class="h-5 w-5" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
                <path d="M3 9v6h4l5 5V4L7 9H3zm13.5 3c0-1.77-1.02-3.29-2.5-4.03v8.05c1.48-.73 2.5-2.25 2.5-4.02zM14 3.23v2.06c2.89.86 5 3.54 5 6.71s-2.11 5.85-5 6.71v2.06c4.01-.91 7-4.49 7-8.77s-2.99-7.86-7-8.77z"/>
              </svg>
              <svg data-icon-muted class="hidden h-5 w-5" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
            ...
            <input
              ...
              value="100"
              aria-label="Volume"
              class="h-1.5 flex-1 cursor-pointer accent-rose-400"
            />
          </div>
        </div>
      </div>
